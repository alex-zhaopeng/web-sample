package com.cangoonline.controller.app.redis;
...
public class RedisDemoController extends BaseController{
	...
	public Object redis(){
		...
		redisDaoImpl.delete("cangoonline");											//删除
		...
		System.out.println(redisDaoImpl.addMap("cangoonline", jmap));				//存储Map
		System.out.println("获取Map:"+redisDaoImpl.getMap("cangoonline"));			//获取Map
		
		result += "获取Map:"+redisDaoImpl.getMap("cangoonline")+",";

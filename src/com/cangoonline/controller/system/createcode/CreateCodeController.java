package com.cangoonline.controller.system.createcode;
...
import com.cangoonline.service.system.createcode.CreateCodeManager;
import com.cangoonline.util.AppUtil;
import com.cangoonline.util.DateUtil;
import com.cangoonline.util.DelAllFile;
import com.cangoonline.util.FileDownload;
import com.cangoonline.util.FileZip;
import com.cangoonline.util.Freemarker;
...
public class CreateCodeController extends BaseController {
	...
	public void proCode(HttpServletResponse response) throws Exception{
		...
		for(int i=0; i< zindex; i++){
			fieldList.add(pd.getString("field"+i).split(",cangoonline,"));	//属性放到集合里面
		}
	...
	public void save(PageData pd) throws Exception{
		...
		pd.put("TABLENAME", pd.getString("tabletop")+",cangoonline,"+pd.getString("objectName").toUpperCase());	//表名

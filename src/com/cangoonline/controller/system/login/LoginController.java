package com.cangoonline.controller.system.login;
...
import com.cangoonline.service.fhoa.datajur.DatajurManager;
import com.cangoonline.service.system.appuser.AppuserManager;
import com.cangoonline.service.system.buttonrights.ButtonrightsManager;
import com.cangoonline.service.system.fhbutton.FhbuttonManager;
import com.cangoonline.service.system.fhlog.FHlogManager;
import com.cangoonline.service.system.loginimg.LogInImgManager;
import com.cangoonline.service.system.menu.MenuManager;
import com.cangoonline.entity.system.Menu;
import com.cangoonline.entity.system.Role;
import com.cangoonline.entity.system.User;
import com.cangoonline.service.system.role.RoleManager;
import com.cangoonline.service.system.user.UserManager;
...
import com.cangoonline.util.RightsHelper;
...
public class LoginController extends BaseController {
	...
	public Object login()throws Exception{
		...
		pd = this.getPageData();
		String errInfo = "";
		String KEYDATA[] = pd.getString("KEYDATA").split(",cangoonline,");
        Session session = Jurisdiction.getSession();
        if(null != KEYDATA && KEYDATA.length == 3){
            String strLo[] = getLoginEdit(pd);
            String isVcode = strLo.length == 3 ? strLo[2] : "";
            if("yes".equals(isVcode)){
                String sessionCode = (String)session.getAttribute(Const.SESSION_SECURITY_CODE);		//获取session中的验证码
                String code = KEYDATA[2];

                if(null == code || "".equals(code)){//判断效验码
                    errInfo = "nullcode"; 			//效验码为空
                }else if (Tools.notEmpty(sessionCode) && !sessionCode.equalsIgnoreCase(code)){

package com.cangoonline.dao.redis.impl;
...
import com.cangoonline.dao.AbstractBaseRedisDao;
import com.cangoonline.dao.redis.RedisDao;
import com.cangoonline.util.DbFH;
...
public class RedisDaoImpl extends AbstractBaseRedisDao<String, PageData> implements RedisDao{
	...
	/**删除
	 * (non-Javadoc)
	 * @see com.cangoonline.dao.redis.RedisDao#delete(String)
	 */
	@Override
	...
	/**删除多个
	 * (non-Javadoc)
	 * @see com.cangoonline.dao.redis.RedisDao#delete(List)
	 */
	@Override
	...
	/**修改
	 * (non-Javadoc)
	 * @see com.cangoonline.dao.redis.RedisDao#eidt(String, String)
	 */
	@Override
	...
	/**通过key获取值
	 * (non-Javadoc)
	 * @see com.cangoonline.dao.redis.RedisDao#get(String)
	 */
	@Override

package com.fh.controller.approve.approvepool;
...
import com.fh.service.approve.approvepool.ApprovePoolManager;
...
public class ApprovePoolController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"新增ApprovePool");
		if(!Jurisdiction.buttonJurisdiction(menuUrl, "add")){return null;} //校验权限
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		pd.put("APPROVEPOOL_ID", this.get32UUID());	//主键
		approvepoolService.save(pd);
